...
const CACHE_NAME = 'wit-dashboard-v6';
const CORE_ASSETS = ['./', './index.html', './styles.css?v=1.3.5', './dashboard-ui.js?v=1.3.5', './app.js?v=1.3.5', './manifest.json', './icon.svg', './icon-192.png', './icon-512.png'];
