...
const CACHE_NAME = 'wit-dashboard-v5';
const CORE_ASSETS = ['./', './index.html', './styles.css?v=1.3.4', './dashboard-ui.js?v=1.3.4', './app.js?v=1.3.4', './manifest.json', './icon.svg', './icon-192.png', './icon-512.png'];
